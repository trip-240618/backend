...
public class OAuthController {
    ...
    public Mono<ResponseEntity<?>> handleOAuth2Callback(
        ...
        return kakaoOAuth2Service.getUserInfo(kakaoToken)
                ...
                .map(userInfo -> {
                    ...
                    UserInfoDto userInfoDto = oAuthService.whenLoginKakao(oauthId, name, null, profileImageUrl, "KAKAO",
                            fcmToken, response);
                    log.info("애플 로그인\nname : {}", name);
    ...
    public ResponseEntity<?> googleLogin(
        ...
        UserInfoDto userInfoDto = oAuthService.whenLoginSocial("google", requestBody.getIdToken(), response);
    ...
    public ResponseEntity<?> appleLogin(
        ...
        UserInfoDto userInfoDto = oAuthService.whenLoginSocial("apple", requestBody.getIdToken(), response);
